	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
          ...
          <li><a href="{{('/')}}">Home</a></li>
					 ...
					 <li class="colorlib-active"><a href="{{('/portfolio')}}">Project</a></li>
...
<?php foreach ($works as $work): ?>
       ...
       <div class="view overlay zoom">
           <img src="{{asset('storage/'.$work->image)}}" class="img-responsive " alt="smaple image">
           <div class="mask flex-center">
               <p class="white-text">{{$work->title}}</p>
           </div>
       </div>
						</div>
