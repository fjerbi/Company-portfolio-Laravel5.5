	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
          ...
          <li><a href="{{('/')}}">Home</a></li>
					...
					<li class="colorlib-active"><a href="{{('/organigramme')}}">Organigramme</a></li>
				
					<li><a href="contact.html">Devis/Questions</a></li>
					<li><a href="{{('/references')}}">References</a></li>
					<li><a href="{{('/acebet')}}">ACE NET</a></li>
				...
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							<span class="heading-meta">ORGANIGRAMME</span>
							<h2 class="colorlib-heading">NOTRE ORGANIGRAMME</h2>
						</div>
					</div>
					<div class="row row-bottom-padded-md">
<img src="https://www.votreassistante.net/wp-content/uploads/2013/07/organigramme-word-termine.jpg" width="1000" height="1000">
